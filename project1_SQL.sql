...
# For all ticket buyers, get their emails, age group, the movie name they watched, the show time, and the ticket price (Stored Procedure Involving a JOIN and Input)
DELIMITER //
