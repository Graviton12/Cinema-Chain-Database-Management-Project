...
-- what is the information for the all ticket buyers
CALL ticket_buyer_info();

# Get the number of movies scheduled per theater (Stored Procedure)
DELIMITER //

CREATE PROCEDURE movies_per_theater()
BEGIN
    SELECT theater_num, COUNT(*) AS num_movies
    FROM MOVIE
